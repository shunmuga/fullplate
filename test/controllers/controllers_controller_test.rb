...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { User: @controller.User, address: @controller.address, email: @controller.email, name: @controller.name, zip: @controller.zip } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { User: @controller.User, address: @controller.address, email: @controller.email, name: @controller.name, zip: @controller.zip } }
